                        ...
                        <div class="testimonials_one_single_item">
                            <div class="text">
                                <p>
                                    ...
                                    consectetuer in nam. Eu quo laoreet propriae, malis
                                    exerci habemus has vocent persius eum ea.
                                </p>
                            </div>
                            <div class="client_thumbnail">
                                <div class="client_img">
                                    <img src="{{asset('assets/images/testimonials/testimonial-1-img-1.png')}}" alt="testimonial1-img" />
                                </div>
