                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            <!-- <div class="form-group">
                                ...
                                <select name="category_name" class="form-control">
                                    ...
                                    @foreach($post_categories as $post_category)
                                        <option value="{{ $post_category->id }}"selected>{{ $post_category->category_name }}</option>
                                    @endforeach
                                </select>
                            </div> -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="meta_keyword" class="form-control" rows="1" placeholder="Enter keywords" required>{{ $post->meta_keyword }}</textarea>
                            </div>
                            <div class="form-group">
