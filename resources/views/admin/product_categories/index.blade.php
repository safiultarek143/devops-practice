...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{ route('product-categories.create') }}" class="btn btn-info fa-pull-right"><i class="fa fa-plus"></i> Add new</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                ...
                @if(!empty($product_categories))
                    @foreach($product_categories as $key => $product_category)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-info" href="{{ route('product-categories.edit',$product_category->id) }}"><i class="fa fa-edit"></i> Edit</a>
                                @include('includes.master._confirm_delete',[
                                    'id' => $product_category->id,
                                    'url' => route('product-categories.destroy',$product_category->id),
